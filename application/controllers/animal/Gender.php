...
class Gender extends RestManager {
    ...
    public function index_get()
    {
        ...
        if (isset($queryString) && count($queryString) > 0) {
            ...
            $dataModel[0]['filterKey'] = $queryString['q'] !== 'null' ? 'WHERE name like "%'.$queryString['q'].'%" or animals_gender_id like "%'.$queryString['q'].'%"' : null;
        ...
        foreach ($data['data'] as $key => $value) {
            ...
            $animalId = (int) $data['data'][$key]['animals_gender_id'];
            $data['data'][$key]['animals_gender_id'] = $animalId;
        }
